...
void loop() {
  ...
  // Beispiele der verschiedenen Zeichenbefehle.
  // Die fill... Aufrufe gibt es auch als draw... Variante.
  
  canvas.drawPixel(2, 5, toCanvasColor(0, 255, 0));
  // canvas.drawLine(1, 2, 6, 5, toCanvasColor(255, 255, 0));
  // canvas.fillTriangle(1, 1, 6, 3, 3, 6, toCanvasColor(255, 0, 255));
  // canvas.fillRect(2, 2, 4, 4, toCanvasColor(255, 0, 255));
  // canvas.fillRoundRect(1, 1, 6, 6, 2, toCanvasColor(255, 255, 255));
  // canvas.fillCircle(4, 4, 3, toCanvasColor(0, 255, 255));
